...
//
// An embed directive cannot reach outside its own package directory, and the catalog belongs at
// the top of the repository where a contributor adding an add-on will actually look for it. So
